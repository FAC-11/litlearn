...
exports.get = (req, res, next) => {
  ...
  const sqlQuery = `SELECT questions.id, questions.summary, string_agg(tags.tag, ', ') AS filter FROM questions INNER JOIN many2many ON questions.id=many2many.question_id INNER JOIN tags on many2many.tag_id = tags.id GROUP BY questions.summary, questions.id;`;
